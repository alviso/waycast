...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    esp_lcd_dsi_bus_config_t bus_config = {
        ...
        .phy_clk_src = 0, /* 0 = driver picks per silicon revision.
            * The legacy macro (PLL_F20M) hard-aborts in the HAL on
            * v3.1 silicon (mipi_dsi_ll.h default: abort()) — found
            * bringing up the WIFI6-DEV-KIT-C, July 2026. */
...
#if CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH || CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH_A
            .swap_xy = 0,
    /* these flags assume the 270-degree mount; a 90-degree mount
     * (WIFI6-DEV-KIT-C) is 180 off, so un-mirror both axes */
